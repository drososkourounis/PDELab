...
%     Test Jacobi and Chebyshev
      ...
      if ( test == 1 | test == 6 ),
         ...
         if ( flag_cheby ~= 0 & test ~= 6 ),
            ...
            fprintf('Cheby converge in %d iterations with residual norm %25.26e\n',iter,error);
...
%     SPD ROUTINES
      ...
      if ( test == 1 | test == 2 | test == 4 | test == 6 ), 
         ...
         if ( flag_cg ~= 0 & test ~= 6 ),
            ...
            fprintf('CG    converge in %d iterations with residual norm %25.26e\n',iter,error);
...
%     Nonsymmetric ROUTINES
      ...
      if ( test == 1 | test == 4 | test == 5 | test == 6 ) 
         ...
         if ( flag_gmres ~= 0 & test ~= 6 ),
            ...
            fprintf('GMRES converge in %d iterations with residual norm %25.26e\n',iter,error);
         ...
         if ( flag_cgs ~= 0 & test ~= 6 ),
            ...
            fprintf('CGS   converge in %d iterations with residual norm %25.26e\n',iter,error);
         ...
         if ( flag_bicgs ~= 0 & test ~= 6 ),
            ...
            fprintf('BICGSTAB converge in %d iterations with residual norm %25.26e\n',iter,error);
         ...
         if ( flag_qmr ~= 0 & test ~= 6 ),
            ...
            fprintf('QMR converge in %d iterations with residual norm %25.26e\n',iter,error);
